...
public class ManifestFilterOptions : IPlatformFilterableOptions, IDockerfileFilterableOptions
{
...
{
    private PlatformFilterOptionsBuilder _platformFilterOptionsBuilder = new();
    private DockerfileFilterOptionsBuilder _dockerfileFilterOptionsBuilder = new();
