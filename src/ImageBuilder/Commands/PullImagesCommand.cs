    ...
    public class PullImagesCommand : ManifestCommand<PullImagesOptions, PullImagesOptionsBuilder>
    {
        ...
        public override Task ExecuteAsync()
        {
            ...
            else
            {
                ...
                ImageArtifactContext context = ImageInfoHelper.LoadFromFileWithContext(
                ...
                platformTags = context.Details.Repos
                    ...
                    .Where(platform => context.GetPlatformInfo(platform) is not null && platform.SimpleTags.Any())
                    .Select(platform =>
                    {
                        PlatformInfo platformInfo = context.GetPlatformInfo(platform)!;
                        return (
                            TagInfo.GetFullyQualifiedName(platformInfo.FullRepoModelName, platform.SimpleTags.First()),
