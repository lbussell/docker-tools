...
namespace Microsoft.DotNet.ImageBuilder.Commands
{
    public class PullImagesCommand : ManifestCommand<PullImagesOptions, PullImagesOptionsBuilder>
    {
        ...
        public PullImagesCommand(IManifestJsonService manifestJsonService, IDockerService dockerService, ILogger<PullImagesCommand> logger, IImageInfoService imageInfoService) : base(manifestJsonService)
        {
