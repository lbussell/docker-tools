    ...
    private static Lazy<IServiceProvider> ServiceProvider { get; } = new(() =>
        {
            ...
            builder.ConfigureServices((context, services) =>
            {
                ...
                // Read publishConfig from appsettings/configuration
            ...
            var publishConfig = host.Services.GetRequiredService<IOptions<PublishConfiguration>>().Value;
            Console.WriteLine($"Publish Config: {publishConfig}");
