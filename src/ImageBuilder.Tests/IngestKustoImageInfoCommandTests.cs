...
@"""zxc"",""0"",""1"",""jkl"",""amd64"",""Linux"",""Ubuntu 24.04"",""1.0.5"",""1.0/sdk/os/Dockerfile"",""repo1"",""2020-04-20 21:56:58""";
            ...
            string expectedLayerData)
        {
            ...
            IngestKustoImageInfoCommand command = new(TestHelper.CreateManifestJsonService(), Mock.Of<ILogger<IngestKustoImageInfoCommand>>(), kustoClientMock.Object, TestHelper.CreateRealImageInfoService());
