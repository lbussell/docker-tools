...
/// <summary>
/// A node in a build timeline tree, with children pre-resolved from the flat API response.
/// Filters to Stage, Job, and Task record types, skipping intermediate types like Phase.
/// </summary>
/// <param name="Record">The underlying timeline record.</param>
/// <param name="Children">The child nodes, ordered by <see cref="TimelineRecord.Order"/>.</param>
